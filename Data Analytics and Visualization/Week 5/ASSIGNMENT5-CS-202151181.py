...
# %%
# Load datasets
df1 = pd.read_csv("/Users/yashsingh/Desktop/Data Analytics and Visualization/Week 5/Egg_Production_2007_2012.csv")
df2 = pd.read_csv("/Users/yashsingh/Desktop/Data Analytics and Visualization/Week 5/Milk_Production_2007_2012.csv")
...
squarify.plot(sizes=eggVal, label=eggLab, color=[plt.cm.tab20c(i/len(eggVal)) for i in range(len(eggVal))], alpha=0.7, pad=True)
plt.axis('off')
...
squarify.plot(sizes=milkVal, label=milkLab, color=[plt.cm.tab20c(i/len(milkVal)) for i in range(len(milkVal))], alpha=0.7, pad=True)
plt.axis('off')
